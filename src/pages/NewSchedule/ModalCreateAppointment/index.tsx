...
export default function ModalCreateAppointment({
  ...
  return (
    <>
      ...
      >
        <ModalContent size="lg" title="Novo agendamento">
          <ModalNewAppointmentContainer>
            <div
              style={{
                overflow: 'auto',
      ...
      <Modal
        ...
        onOpenChange={() => setModalSelectUser(false)}
      >
        <ModalContent title="Selecione o usuário">
      ...
      >
        <ModalContent title="Novo usuário" size="md">
